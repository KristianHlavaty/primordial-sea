...
function roomList() {
  return [...rooms.values()].map(r => ({
    ...
    fantasy: r.fantasy, evolution: r.evolution, cheats: r.cheats, bosses: r.bosses, mapTransitions: r.mapTransitions, items: r.items, funItems: r.funItems,
  ...
  switch (m && m.t) {
    ...
    case 'createRoom': {
      ...
      const r = {
        ...
        bosses: m.bosses === true, mapTransitions: m.mapTransitions === true, items: m.items !== false,
        funItems: m.items !== false && m.funItems === true,
