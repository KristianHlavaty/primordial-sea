...
export const SPECIES = {
  ...
  // Optional swift-fish future: a fish-first lineage that only completes its
  // hunched, lure-bearing "Lantern Maw" body plan in the Carboniferous.
  mudfin_strider: { name: 'Mudfin Strider', tier: 1, branch: 'tideborn', stage: 'devonian', landfall: true, fantasy: true, seaBranches: ['chord'], seaSpecies: ['xenacanthus'], desc: 'Fantasy: a long-bodied shark descendant that still swims like a fish, using broad paired fins to cross wet mud.', stats: { hp: 225, accel: 1120, maxSpeed: 275, dmg: 36, reach: 16, radius: 22, dashCd: .38, dashPow: 455, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 29, wid: 11, body: '#477f83', accent: '#9fe5d5', maw: '#35484e', tail: 1.25, limb: .18, morph: .06, lure: 0, gape: .05, stripes: 5, spots: 0 }), evolvesTo: ['reedscale_stalker'] },
  reedscale_stalker: { name: 'Reedscale Stalker', tier: 2, branch: 'tideborn', stage: 'devonian', fantasy: true, desc: 'Fantasy: an amphibious fish with stronger fin-lobes, a low skull and faint sensory photophores for hunting among reeds.', stats: { hp: 270, accel: 1140, maxSpeed: 280, dmg: 42, reach: 18, radius: 24, dashCd: .37, dashPow: 465, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 31, wid: 12.5, body: '#3c7478', accent: '#8bdcc7', maw: '#3d444c', tail: 1.1, limb: .28, morph: .14, lure: .08, gape: .1, stripes: 4, spots: 2 }), evolvesTo: ['gillrunner'] },
  gillrunner: { name: 'Gloomfin Hunter', tier: 3, branch: 'tideborn', stage: 'devonian', fantasy: true, desc: 'Fantasy: still unmistakably fish-like, but muscular walking fins and a glowing lure-bud let it pursue prey beyond the waterline.', stats: { hp: 315, accel: 1170, maxSpeed: 290, dmg: 49, reach: 20, radius: 27, dashCd: .35, dashPow: 485, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 34, wid: 14, body: '#315f68', accent: '#77d6bd', glow: '#87f2bf', maw: '#51434f', tail: .96, limb: .4, morph: .24, lure: .2, gape: .18, stripes: 3, spots: 3 }), evolvesTo: ['tide_hunter'] },
  tide_hunter: { name: 'Lurefin Hunter', tier: 4, branch: 'tideborn', stage: 'devonian', fantasy: true, desc: 'Fantasy: a large predatory fish at the edge of terrestrial life, with weight-bearing fin-lobes, a small lure and a widening frontal bite.', stats: { hp: 355, accel: 1200, maxSpeed: 300, dmg: 56, reach: 22, radius: 29, dashCd: .34, dashPow: 500, turn: 15 }, plan: P({ kind: 'lanternwalker', len: 37, wid: 16, body: '#294f5a', accent: '#70cfac', glow: '#8ff5c0', maw: '#624958', tail: .8, limb: .54, morph: .36, lure: .38, gape: .2, stripes: 2, spots: 4 }), evolvesTo: ['bog_tide_hunter'] },
  bog_tide_hunter: { name: 'Coal-Marsh Angler', tier: 1, branch: 'tideborn', stage: 'carboniferous', fantasy: true, desc: 'Fantasy: humid coal swamps free the lurefin from open water; its shoulders rise, its tail recedes and its luminous lure becomes a true hunting organ.', stats: { hp: 395, accel: 1190, maxSpeed: 300, dmg: 60, reach: 23, radius: 31, dashCd: .34, dashPow: 505, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 38, wid: 18, body: '#263f49', accent: '#68dda7', glow: '#91ffc4', maw: '#725168', tail: .58, limb: .82, morph: .58, lure: .62, gape: .5, stripes: 2, spots: 5, spines: 2 }), evolvesTo: ['mire_lurker'] },
  ...
  mire_lurker: { name: 'Mire Lurejaw', tier: 2, branch: 'tideborn', stage: 'carboniferous', fantasy: true, desc: 'Fantasy: a hunched root-tangle ambusher whose lure imitates swamp fire while its entire face opens into a tooth-ringed maw.', stats: { hp: 430, accel: 1150, maxSpeed: 295, dmg: 64, reach: 18, radius: 27, dashCd: .35, dashPow: 500, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 32, wid: 16, body: '#223842', accent: '#65e2a9', glow: '#91ffc4', maw: '#7c4f6d', tail: .45, limb: .94, morph: .68, lure: .74, gape: .64, stripes: 3, spots: 6, spines: 3 }), evolvesTo: ['swamp_strider'] },
  swamp_strider: { name: 'Lantern Maw', tier: 3, branch: 'tideborn', stage: 'carboniferous', fantasy: true, desc: 'Fantasy: a velvet-dark angler walker with a hypnotic lure, a face-wide mouth and two bright eyes that remain visible on either side of the skull.', stats: { hp: 485, accel: 1180, maxSpeed: 305, dmg: 72, reach: 19, radius: 28, dashCd: .34, dashPow: 505, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 35, wid: 18, body: '#1f333c', accent: '#70f2b1', glow: '#adffd2', maw: '#8b5578', tail: .32, limb: 1.06, morph: .8, lure: .9, gape: .82, stripes: 2, spots: 7, spines: 4 }), evolvesTo: ['coal_leviathan'] },
  coal_leviathan: { name: 'Coaljaw Deceiver', tier: 4, branch: 'tideborn', stage: 'carboniferous', fantasy: true, desc: 'Fantasy: an enormous marsh angler whose pulsing lure resembles helpless prey until the mouth beneath it unfolds.', stats: { hp: 555, accel: 1200, maxSpeed: 312, dmg: 86, reach: 21, radius: 31, dashCd: .34, dashPow: 510, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 40, wid: 20, body: '#1a2b35', accent: '#62efac', glow: '#9dffca', maw: '#914e76', tail: .2, limb: 1.18, morph: .9, lure: 1, gape: .92, stripes: 1, spots: 8, spines: 5 }), evolvesTo: ['tar_sovereign'] },
  tar_sovereign: { name: 'Abyssal Deceiver', tier: 5, branch: 'tideborn', stage: 'carboniferous', fantasy: true, desc: 'Fantasy: the apex Lantern Maw, trailing ghost lights through the tar-dark forest before swallowing armored prey whole.', stats: { hp: 640, accel: 1210, maxSpeed: 316, dmg: 96, reach: 22, radius: 34, dashCd: .33, dashPow: 515, turn: 14 }, plan: P({ kind: 'lanternwalker', len: 44, wid: 22, body: '#16252e', accent: '#9affc7', glow: '#baffda', maw: '#a24f7e', tail: .12, limb: 1.3, morph: 1, lure: 1.15, gape: 1, stripes: 0, spots: 10, spines: 6 }), evolvesTo: [] },
