...
export const NPCS = {
  ...
  gilboa_hunter: { role: 'predator', stage: 'devonian', maps: ['silken_grove'], weight: 2.2, minEra: 0, hp: 155, dmg: 24, accel: 1080, maxSpeed: 265, radius: 20, sense: 430, meat: 6, value: 15, aggro: true, plan: P({ kind: 'arachnid', len: 27, wid: 14, body: '#46383a', accent: '#bd7a88', legs: 8, eyes: 8, abdomen: 1.1, pedipalps: .9, spinnerets: 2, abdomenMarks: 4 }) },
