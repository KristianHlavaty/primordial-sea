...
import { SPECIES, LAND_PIONEERS } from '../../data/species.js';
  ...
  return html`
    <div className="scrim"><div className="card">
      ...
      <div className="body">
        ...
        onto the land, where new maps, creatures and powers await. Each evolution grants a new <b>power</b>,
        ...
        ${showLand && html`
          <div className="skipChoices">
            ...
            <div className="skipBtns">
              ${LAND_PIONEERS.map(id => {
                const sp = SPECIES[id];
                return html`<button key=${id} className=${'skipBtn ' + sp.branch} onClick=${() => onSkipToLand(id)}>
